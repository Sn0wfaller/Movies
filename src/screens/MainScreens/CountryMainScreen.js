...
const CountryMainScreen = ({ navigation }) => {
  ...
  const handleDelete = (id) => {
    CountryDataProvider.deleteCountry(id).then(getData);
  ...
  return (
    <Card>
      ...
      />
      <Card.Divider />
      <FlatList style={styles.list} data={countries} renderItem={renderListItem} />
    </Card>
  );
};

export default CountryMainScreen;
